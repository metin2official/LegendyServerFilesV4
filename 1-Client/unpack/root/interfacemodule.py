...
class Interface(object):
	...
	def __MakeWindows(self):
		...
		self.bkBoard=uiBloktanKurtar.BloktanKurtar()
	...
	def Highligt_Item(self, inven_type, inven_pos):
		...
		elif app.ENABLE_SPECIAL_STORAGE and (inven_type == player.BOOK_INVENTORY or inven_type == player.UPGRADE_INVENTORY or inven_type == player.STONE_INVENTORY or inven_type == player.CHEST_INVENTORY):
	...
	def BloktanKurtarOpen(self):
		self.bkBoard.Open()
	def BloktanKurtarGuiGG(self,guiGG):
		self.bkBoard.GosterGizle(guiGG)
	def BloktanKurtar(self):
		self.bkBoard.BloktanKurtar()
