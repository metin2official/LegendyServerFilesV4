...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_CHEST_DROP_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_CHEST_DROP_SYSTEM", 0);
#endif

#ifdef ENABLE_RACE_HEIGHT_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_RACE_HEIGHT_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RACE_HEIGHT_RENEWAL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_UPGRADE_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_UPGRADE_EFFECT", 0);
#endif

#ifdef ENABLE_DUEL_EFFECT
	PyModule_AddIntConstant(poModule, "ENABLE_DUEL_EFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DUEL_EFFECT", 0);
#endif
