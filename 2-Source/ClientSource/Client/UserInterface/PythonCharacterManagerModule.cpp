...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_UPSUCCESS", CInstanceBase::EFFECT_UPSUCCESS);
	PyModule_AddIntConstant(poModule, "EFFECT_UPFAILED", CInstanceBase::EFFECT_UPFAILED);
#endif
