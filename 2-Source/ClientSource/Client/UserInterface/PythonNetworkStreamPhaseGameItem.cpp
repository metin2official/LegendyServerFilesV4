...
bool CPythonNetworkStream::SendShopSellPacketNew(UINT bySlot, BYTE byCount, BYTE byType)
#else
...
bool CPythonNetworkStream::RecvSpecialEffect()
{
	...
	switch (kSpecialEffect.type)
	{
		...
		case SE_UPSUCCESS:
			effect = CInstanceBase::EFFECT_UPSUCCESS;
			break;
		case SE_UPFAILED:
			effect = CInstanceBase::EFFECT_UPFAILED;
			break;
#endif
