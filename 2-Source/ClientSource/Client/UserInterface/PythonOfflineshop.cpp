...
void CPythonOfflineshop::OpenShop(const offlineshop::TShopInfo& shop, const std::vector<offlineshop::TItemInfo>& vec)
{
	...
	for (DWORD i = 0; i < vec.size(); i++)
	{
...

		{
			...
			ApplyPyMethod("OpenShopItem_SetValue",  Py_BuildValue("(sii)", "evolution", i , item.item.iEvolution));
#endif
...
#endif
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
			ApplyPyMethod("OpenShopOwnerItem_SetValue", Py_BuildValue("(sii)", "evolution", i, item.item.iEvolution));
#endif
...
#endif
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
			ApplyPyMethod("OpenShopOwnerItemSold_SetValue", Py_BuildValue("(sii)", "evolution", i, item.item.iEvolution));
#endif
			for(int j =0; j < ITEM_ATTRIBUTE_SLOT_MAX_NUM; j++)
...
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
			ApplyPyMethod("ShopFilterResultItem_SetValue",	Py_BuildValue("(sii)", "evolution",	i,	item.item.iEvolution));
#endif
			for(int j =0; j < ITEM_ATTRIBUTE_SLOT_MAX_NUM; j++)
...
#endif
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
		ApplyPyMethod("OfferList_ItemSetValue",			Py_BuildValue("(si)",		"evolution", itemInfo.iEvolution));
#endif
...
#endif
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
		ApplyPyMethod("ShopSafebox_SetValue",		Py_BuildValue("(si)", "evolution", itemInfo.iEvolution));
#endif
...
#endif
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
		ApplyPyMethod("AuctionList_SetItemEvolution", Py_BuildValue("(i)", item.iEvolution));
#endif
...
#endif
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
	ApplyPyMethod("MyAuction_SetItemEvolution", Py_BuildValue("(i)", item.iEvolution));
#endif
...
#endif
#ifdef ENABLE_WEAPON_EVOLUTION_SYSTEM
	ApplyPyMethod("OpenAuction_SetItemEvolution", Py_BuildValue("(i)", item.iEvolution));
#endif
