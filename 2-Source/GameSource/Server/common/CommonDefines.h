...
#define ENABLE_PENDANT_SYSTEM																		// Tılsım Sistemi
#define ENABLE_TILSIM_EFSUNLAMA																		// Tılsım Efsunlama
#define ENABLE_SPECIAL_STORAGE																		// K Envanter Modulu
#define ENABLE_GOLD_REWARD_RENEWAL																	// Yere düşen yang düzenlemesi
#define ENABLE_SHOW_CHEST_DROP_SYSTEM																// Sandik Aynası Modulu
#define ENABLE_KILL_STATISTICS																		// Kill istatistik
#define ENABLE_AGGREGATE_MONSTER_EFFECT																// Cesaret Pelerin Efekti
#define __IMPROVED_HANDSHAKE_PROCESS__																// Anti DDOS Sistemi
#define ENABLE_UPGRADE_EFFECT																		// + Basma Efekti - Upgrade Effect
#define ENABLE_DUEL_EFFECT																			// Düello Efekti
#define ENABLE_TIME_CONTROL
#define ENABLE_STATUS_UP_RENEWAL																	// Hızlı Statiü
