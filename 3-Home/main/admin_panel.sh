...
;;
888|symlink)
	[ ! -d "$v_mt2f/$v_foldername/share/bin" ] && mkdir -p "$v_mt2f/$v_foldername/share/bin"
	cd "$v_mt2f/$v_foldername/share/bin"
	rm -f game db
	ln -s ../../../../../2-Source/GameSource/Server/game/game_symlink game
	ln -s ../../../../../2-Source/GameSource/Server/db/db_symlink db
